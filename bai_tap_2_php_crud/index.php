...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-2 bg-white ">
        ...
        <div class="menu">
            <h3 data-bs-toggle="collapse" href="#menu1" aria-expanded="false" justify-content-between>
                <i class="fa-regular fa-user"></i> User<i class="fa-solid fa-chevron-down"></i>
            </h3>
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <form action="" style="background-color: white; border-radius: 15px;">
                <div class="d-flex align-items-center p-1">
                    ...
                    <i class="fa-solid fa-magnifying-glass p-1" style="margin-right: 10px;"></i>
                    </a>
